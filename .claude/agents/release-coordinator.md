...
2. Confirm durable outputs are limited to `products/`, `oss/projects.yaml`, `docs/knowledge/`, framework docs, scripts, and config.
3. Review PR readiness and release notes.
4. Ensure human gates and validation history are complete before merge.

## Outputs

- Release readiness notes in `handoffs/`
